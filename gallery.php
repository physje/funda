...
if(isset($_POST['add'])) {
	...
	foreach($dataset as $huisID) {
		...
		# Letop dat de <div class='float_rechts'> eerst staan, en pas daarna de linkertekst.
		...
		$Foto .= "	<div class='float_rechts'>". getDoorloptijd($huisID) ."</div><a href='http://www.funda.nl". $data['url'] ."' target='_blank' class='$TextClass'>$adres</a><br>\n";
