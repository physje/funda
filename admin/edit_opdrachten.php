	...
	foreach($Opdrachten as $OpdrachtID) {
		...
		if($active) {
			...
			if($_SESSION['level'] > 1) {
				...
				$Page .= "	<td>&nbsp;</td>";
				$Page .= "	<td><a href='renewData.php?OpdrachtID=$OpdrachtID'><img src='http://www.marinusjansen.nl/images/icon-funda.png' width='16' height='16' title=\"Haal alle data voor '". $OpdrachtData['naam'] ."' opnieuw op\"></a></td>";
				$Page .= "	<td>&nbsp;</td>";
