...
if(isset($_POST['doorgaan'])) {
	...
	$Page .= "</tr>\n";	
	$Page .= "<tr>\n";
	$Page .= "	<td>Laatste controle</td>\n";
	$Page .= "	<td>". ($data['last_check'] > 0 ? date('d M H:i', $data['last_check']) : 'nooit') ."</td>\n";
	$Page .= "</tr>\n";
	$Page .= "<tr>\n";
	$Page .= "	<td colspan='3'>&nbsp;</td>\n";
	$Page .= "</tr>\n";
	$Page .= "<tr>\n";
	$Page .= "	<td colspan='3'><table width='100%'><tr><td><input type='submit' name='doorgaan' value='Opslaan'></td><td align='right'><input type='submit' name='delete_opdracht' value='Verwijderen'></td></tr></table></td>\n";
	$Page .= "</tr>\n";
	$Page .= "</table>\n";
	$Page .= "</form>\n";
} else  {
