...
if(isset($_POST['combine'])) {	
	...
	$deel_1 .= "<tr>\n";
	$deel_1 .= "	<td>Selectie 1</td>\n";	
	$deel_1 .= "	<td rowspan='2'>&nbsp;</td>\n";
	$deel_1 .= "	<td>Selectie 2</td>\n";
	$deel_1 .= "	<td rowspan='2'>&nbsp;</td>\n";
	$deel_1 .= "	<td>&nbsp;</td>\n";
	$deel_1 .= "</tr>\n";
	$deel_1 .= "<tr>\n";
	...
	$deel_1 .= "</tr>\n";
	$deel_1 .= "<tr>\n";
	$deel_1 .= "	<td colspan='5'>&nbsp;</td>\n";
	$deel_1 .= "</tr>\n";
	$deel_1 .= "<tr>\n";
	$deel_1 .= "	<td colspan='5' align='center'><input type='submit' name='combine' value='Weergeven'></td>\n";
	$deel_1 .= "</tr>\n";
	$deel_1 .= "</table>\n";
	$deel_1 .= "</form>\n";
}
